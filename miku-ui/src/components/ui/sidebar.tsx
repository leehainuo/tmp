      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))] group-data-[side=left]:border-e group-data-[side=right]:border-s',//'group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-e group-data-[side=right]:border-s',
          className
        )}
        {...props}
      >
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant='ghost'
      size='icon'
      className={cn('size-7 border-none shadow-none', className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn(
        'border-sidebar-border ml-3.5 flex min-w-0 translate-x-px flex-col gap-2 border-s pl-4 py-2',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground flex h-9 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-inherit',
